...
interface NewATSPerformanceTrackerProps {
  resumeData?: {
    personalInfo?: any;
    summary?: string;
    workExperience?: any[];
...
const NewATSPerformanceTracker: React.FC<NewATSPerformanceTrackerProps> = ({ resumeData }) => {
...
export default NewATSPerformanceTracker;
