  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 shadow-lg relative" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <div className="text-center mb-6 border-b border-gray-300 pb-4">
        {personalInfo.name && (
          <h1 className="font-bold text-gray-900 mb-2" style={{ fontSize: '20pt' }}>
            {personalInfo.name}
          </h1>
        )}
      ...
      {summary && (
        <div className="mb-6">
          <h2 className="font-bold text-gray-900 mb-3 border-b border-gray-300 pb-1" style={{ fontSize: '14pt' }}>
            PROFESSIONAL SUMMARY
          </h2>
            ...
            <div key={job.id} className={`mb-4 ${index !== workExperience.length - 1 ? 'border-b border-gray-100 pb-4' : ''}`}>
              <div className="flex justify-between items-start mb-2">
                <div>
                  ...
                  <p className="text-gray-700 font-medium" style={{ fontSize: '12pt' }}>
                    {job.company}
                  </p>
                </div>
                <div className="text-right text-gray-600" style={{ fontSize: '12pt' }}>
